...
class AlllightCommand(sublime_plugin.TextCommand):
    ...
    def setToLight(self, setupJson, setting_filename):
        if "color_scheme" not in setupJson:
            print("no color scheme found in file: " +setting_filename)
        elif "color_scheme_light" not in setupJson:
            print("no light color scheme found")
        else:
            print("setting color scheme to contents of color_scheme_light")
            setupJson["color_scheme"] = setupJson["color_scheme_light"]
